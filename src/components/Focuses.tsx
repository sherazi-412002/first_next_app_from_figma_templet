...
function Focuses() {
  return (
    <div className='w-auto md:w-[1170px] h-auto md:h-[268px] md:ml-[10%] p-3 md:p-0'>
        ...
        <div className='flex flex-col gap-10 md:gap-0 md:flex-row justify-evenly  md:justify-between p-10 md:p-0'>
            ...
            <div className='w-auto md:w-[413px] h-auto md:h-[144px] md:gap-0 flex flex-row gap-5'>
            ...
            <div className='w-auto md:w-[570px] h-auto md:h-[144px] p-2 md:gap-0 flex gap-4'>
