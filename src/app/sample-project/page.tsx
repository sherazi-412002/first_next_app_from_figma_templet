...
function page() {
  return (
    <div className='ml-[10%] flex flex-col gap-10 mt-5'>
      ...
      <div>
        ...
        <Image src={Img01} alt='firstImg' height={1000} width={1000} className='h-[435px] w-[1170px]'/>
      ...
      <div className='flex gap-5'>
        ...
        <Image src={Img02} alt='firstImg' height={1000} width={1000} className='h-[428px] w-[419px]'/>
        <p className='mr-[10%] text-justify w-[721px]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has 
      ...
      <div>
        ...
        <Image src={Img03} alt='firstImg' height={1000} width={1000} className='h-[435px] w-[1170px]'/>
