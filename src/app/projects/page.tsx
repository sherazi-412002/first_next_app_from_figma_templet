...
function page() {
  return (
    <div className='md:ml-[10%] flex flex-col gap-14 p-3 md:gap-10'>
      ...
      <div className='h-auto md:h-[435px] w-auto md:w-[1170px] flex  flex-col md:flex-row gap-5'>
        <div> <Image src={Img01} alt='1stProject' width={1000} height={1000} className='h-[435px] w-auto md:w-[670px]'/></div>
        <div className='flex flex-col justify-between h-auto md:h-[435px] w-auto md:w-[440px]'>
      ...
      <div className='h-auto md:h-[435px] w-auto md:w-[1170px] flex flex-col md:flex-row gap-5'>
        <div> <Image src={Img02} alt='2ndProject' width={1000} height={1000} className='h-auto md:h-[435px] w-auto md:w-[670px]'/></div>
        <div className='flex flex-col justify-between h-auto md:h-[435px] w-auto md:w-[440px]'>
      ...
      <div className='h-auto md:h-[435px] w-auto md:w-[1170px] flex flex-col md:flex-row gap-5'>
        <div> <Image src={Img03} alt='3rdProject' width={1000} height={1000} className='h-auto md:h-[435px] w-auto md:w-[670px]'/></div>
        <div className='flex flex-col justify-between h-auto md:h-[435px] w-auto md:w-[440px]'>
